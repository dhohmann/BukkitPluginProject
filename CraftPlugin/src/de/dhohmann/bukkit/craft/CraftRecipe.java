...
/**
 * Provides same features as a {@link org.bukkit.inventory.ShapedRecipe ShapedRecipe}
 * <p>
 * Enables subclasses to get direct access to the result
...
public class CraftRecipe implements Recipe {
    ...
    /**
     * Create a shaped recipe to craft the specified ItemStack. The constructor merely determines
     * the result and type; to set the actual recipe, you'll need to call the appropriate methods.
     *
     ...
     */
    public CraftRecipe(ItemStack result) {
     ...
     * corresponds with the upper most part of the recipe on the workbench e.g. if all three rows
     ...
     */
    public CraftRecipe shape(final String... shape) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public CraftRecipe setIngredient(char key, MaterialData ingredient) {
     ...
     * @return The changed recipe, so you can chain calls.
     */
    public CraftRecipe setIngredient(char key, Material ingredient) {
     ...
     */
    @Deprecated
    public CraftRecipe setIngredient(char key, Material ingredient, int raw) {
    ...
    protected ItemStack getProtectedResult() {
	return output;
    }
